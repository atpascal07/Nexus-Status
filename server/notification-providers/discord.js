...
class Discord extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            const discordDisplayName = notification.discordUsername || "Nexus-Status";
            ...
            if (heartbeatJSON == null) {
                ...
                if (!webhookHasAvatar) {
                    discordtestdata.avatar_url = "https://github.com/your-org/nexus-status/raw/master/public/icon.png";
                }
            ...
            if (heartbeatJSON["status"] === DOWN) {
                ...
                if (!webhookHasAvatar) {
                    discorddowndata.avatar_url = "https://github.com/your-org/nexus-status/raw/master/public/icon.png";
                }
                if (notification.discordChannelType === "createNewForumPost") {
                ...
                if (!webhookHasAvatar) {
                    discordupdata.avatar_url = "https://github.com/your-org/nexus-status/raw/master/public/icon.png";
                }
